...
| DashboardWindow | Se cierra al alejar el puntero aunque se use el teclado. | **Sin cambio.** La primera versión lo mantenía abierto mientras tuviera foco de teclado, pero el cajón se activa al abrirse y el foco queda dentro siempre: dejaba de cerrarse al apartar el ratón. Revertido en revisión. | Una forma de abrir y recorrer el cajón solo con teclado. |
